...
resource "alicloud_vpc" "vpc_shared_service" {
  vpc_name   = var.network_settings.vpc_shared_services.vpc_name
...
resource "alicloud_vpc" "vpc_dmz" {
  vpc_name   = var.network_settings.vpc_dmz.vpc_name
